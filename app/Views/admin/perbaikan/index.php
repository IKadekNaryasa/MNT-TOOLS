    ...
    <div class="page-inner">
        <div class="page-header">
            ...
            <ul class="breadcrumbs ms-0">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('admin/perbaikan'); ?>">Perbaikan</a>
                </li>
            </ul>
        </div>
        <!-- komponen -->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <button class="btn btn-success btn-sm float-end mx-1" data-bs-toggle="modal" data-bs-target="#exportDataPerbaikan">
                                    ...
                                    <?php foreach ($perbaikan as $prwt): ?>
                                        <tr>
                                            ...
                                            <td class="form-control-sm">
                                                <?php
                                                if ($prwt['statusPerbaikan'] == 'on progres') {
...
<!-- modal -->
<?php foreach ($perbaikan as $prwt2): ?>
    <div class="modal fade" id="modal-<?= $prwt2['perbaikanId']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h5 class="modal-title">Selesai Perbaikan</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url('admin/perbaikan/update'); ?>" method="post">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="perbaikanId" value="<?= $prwt2['perbaikanId']; ?>">
...
<!-- modal export -->
<div class="modal fade" id="exportDataPerbaikan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h5 class="modal-title">
                    <span class="fw-mediumbold">Export Data Perbaikan</span>
                </h5>
                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
